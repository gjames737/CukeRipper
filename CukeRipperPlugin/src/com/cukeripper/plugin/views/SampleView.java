...
public class SampleView extends ViewPart {
	 ...
	 */
	public static final String ID = "com.cukeripper.plugin.views.SampleView";
	...
	class ViewContentProvider implements IStructuredContentProvider {
		...
		public Object[] getElements(Object parent) {
			...
			String[] FeatureFileNames = new String[featureFiles.length];
			for (int i = 0; i < featureFiles.length; i++) {
				FeatureFileNames[i] = featureFiles[i].getName();
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem()
				.setHelp(viewer.getControl(), "com.cukeripper.plugin.viewer");
		makeActions();
		hookContextMenu();
